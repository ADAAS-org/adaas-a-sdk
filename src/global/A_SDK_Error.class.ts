...
export class A_SDK_Error extends Error {
    ...
    constructor(
        params: A_SDK_TYPES__Error | Error | AxiosError | A_AUTH_Error | any
    ...
    private identifyErrorType(error: Error | AxiosError | A_SDK_TYPES__Error | A_AUTH_Error) {
        ...
        else if (error instanceof A_AUTH_Error) {
