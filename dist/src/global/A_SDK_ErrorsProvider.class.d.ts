import { A_AUTH_Error, A_TYPES__Dictionary } from "@adaas/a-auth";
...
export declare class A_SDK_ErrorsProvider {
     ...
     * @param registry
     */
    addRegistry(registry: A_TYPES__Dictionary<A_SDK_TYPES__Error>): void;
    /**
     *
     * @param error
     */
     ...
     * @returns
     */
    getError(code: A_SDK_CONSTANTS__ERROR_CODES | string): A_SDK_ServerError | A_SDK_Error | A_AUTH_Error | undefined;
}
