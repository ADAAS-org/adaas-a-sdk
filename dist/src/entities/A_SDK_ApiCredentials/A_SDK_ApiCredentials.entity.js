...
const A_SDK_User_entity_1 = require("../A_SDK_User/A_SDK_User.entity");
const A_SDK_App_entity_1 = require("../A_SDK_App/A_SDK_App.entity");
...
class A_SDK_ApiCredentials extends A_SDK_Base_entity_1.A_SDK_BaseEntity {
    ...
    fromJSON(serialized) {
        ...
        this.User = new A_SDK_User_entity_1.A_SDK_User(serialized.User);
        if (serialized.App)
            this.App = new A_SDK_App_entity_1.A_SDK_App(serialized.App);
    }
    toJSON() {
...
//# sourceMappingURL=A_SDK_ApiCredentials.entity.js.map